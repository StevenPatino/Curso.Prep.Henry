...
* `prototype`: Prototypes son mecanismos en lo cual objetos de JavaScript heredan caracteristicas. 
* _Constructors_ (de Clases): es un metodo especial de crear e inicializar una clase. 
